...
public class TestShiro {
	public static void main(String[] args) {
	   ...
	   subject.checkRoles("news","member");
	   System.out.println(subject.hasRole("news")); 
	   System.out.println(subject.hasRole("member"));
     		//subject.checkPermissions("news:add","news:list","member:add");
	   System.out.println(subject.isPermitted("news:*"));	
	    System.out.println(subject.isPermitted("news:add"));
		System.out.println(subject.isPermittedAll("news:add","news:edit"));
	}
}
